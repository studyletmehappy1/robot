...
class LLMModule:
    ...
    def create_system_prompt(self):
        ...
        return (
            ...
            "2. 每次回复结尾只能输出一个动作标记，且只能从以下动作中选择："
            "(挥手1)、(挥手2)、(挥手3)、(点头1)、(点头2)、(致意1)、(致意2)、"
            "(安抚1)、(安抚2)、(邀请1)、(邀请2)、(无动作)。\n"
            "3. 挥手1表示远距离欢迎、大幅度挥手，适合欢迎大家、欢迎来到展厅、远距离打招呼。\n"
            "4. 挥手2表示近距离、小幅度挥手，适合普通打招呼、近距离问候、轻度回应。\n"
            "5. 挥手3表示更亲和、面向儿童或轻微弯腰挥手，适合小朋友、儿童互动、温柔欢迎。\n"
            "6. 点头1表示简短礼貌回应、确认，适合“好的”“明白了”“收到了”。\n"
            "7. 点头2表示更正式的认可或致意，适合郑重回应、介绍时的礼貌确认。\n"
            "8. 致意1表示轻度鞠躬致意，适合欢迎、感谢、礼貌结束语。\n"
            "9. 致意2表示更正式的鞠躬，适合正式迎宾、正式感谢来访。\n"
            "10. 安抚1表示轻柔单手安抚，适合“别着急”“慢慢说”“我来帮你”。\n"
            "11. 安抚2表示双手安抚，适合需要更强安慰感的家庭场景。\n"
            "12. 邀请1表示单手引导，适合“请进”“请坐”“请看这边”。\n"
            "13. 邀请2表示双手欢迎或引导，适合“欢迎回家”“请到这边”“欢迎进入房间”。\n"
            "14. 如果不需要任何动作，就输出(无动作)。\n"
            "15. 严禁输出任何未定义动作名或额外括号内容。\n"
            "16. 正文只输出面向用户的话，不要解释你为什么选择某个动作。\n"
        )
